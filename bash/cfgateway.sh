urlList=(
    "https://badmojr.gitlab.io/1hosts/Lite/hosts.txt"
...
curl -X PUT "https://api.cloudflare.com/client/v4/accounts/$CF_ID/gateway/rules/eb1d7afc-f87a-4cc4-ab4d-9df3160970d2" \
    ...
    -H "Authorization: $CF_TOKEN" \
    -H "Content-Type: application/json" \
    --data '{"id": "eb1d7afc-f87a-4cc4-ab4d-9df3160970d2","name": "Block Ads and Malicious","description": "","precedence": 10000,"enabled": true,"action": "block","filters": ["dns"],"created_at": "2022-08-24T06:55:54Z","updated_at": "2022-08-25T06:19:46Z","deleted_at": null,"traffic": "dns.fqdn == \"hohoho.ho\"","identity": "","device_posture": "","version": 1,"rule_settings": {"block_page_enabled": false,"block_reason": "","override_ips": null,"override_host": "","l4override": null,"biso_admin_controls": {  "dp": false,  "dcp": false,  "dd": false,  "du": false,  "dk": false},"add_headers": {},"ip_categories": false,"check_session": null,"insecure_disable_dnssec_validation": false}    }'

# de-active ruleH
curl -X PUT "https://api.cloudflare.com/client/v4/accounts/$CF_ID/gateway/rules/5269debd-22e3-4137-9504-8d039c97eb1a" \
    -H "X-Auth-Email: $CF_AC" \
    -H "Authorization: $CF_TOKEN" \
    -H "Content-Type: application/json" \
    --data '{"id": "5269debd-22e3-4137-9504-8d039c97eb1a","name": "Block Ads and Malicious HTTP","description": "","precedence": 12000,"enabled": true,"action": "block","filters": ["http"],"created_at": "2022-08-25T09:01:27Z","updated_at": "2022-08-25T09:01:27Z","deleted_at": null,"traffic": "any(http.request.domains[*] == \"hohoho.ho\")","identity": "","device_posture": "","version": 1,"rule_settings": {"block_page_enabled": false,"block_reason": "Made by Fukuro Aki","override_ips": null,"override_host": "","l4override": null,"biso_admin_controls": {"dp": false,"dcp": false,"dd": false,"du": false,"dk": false},"add_headers": {},"ip_categories": false,"check_session": null,"insecure_disable_dnssec_validation": false}}'
...
curl -X PUT "https://api.cloudflare.com/client/v4/accounts/$CF_ID/gateway/rules/eb1d7afc-f87a-4cc4-ab4d-9df3160970d2" \
    ...
    -H "Authorization: $CF_TOKEN" \
    -H "Content-Type: application/json" \
    --data '{"id": "eb1d7afc-f87a-4cc4-ab4d-9df3160970d2","name": "Block Ads and Malicious","description": "","precedence": 10000,"enabled": true,"action": "block","filters": ["dns"],"created_at": "2022-08-24T06:55:54Z","updated_at": "2022-08-25T06:19:46Z","deleted_at": null,"traffic": "'"$rule"'","identity": "","device_posture": "","version": 1,"rule_settings": {"block_page_enabled": false,"block_reason": "Made by Fukuro Aki","override_ips": null,"override_host": "","l4override": null,"biso_admin_controls": {  "dp": false,  "dcp": false,  "dd": false,  "du": false,  "dk": false},"add_headers": {},"ip_categories": false,"check_session": null,"insecure_disable_dnssec_validation": false}    }'
...
curl -X PUT "https://api.cloudflare.com/client/v4/accounts/$CF_ID/gateway/rules/5269debd-22e3-4137-9504-8d039c97eb1a" \
    ...
    -H "Authorization: $CF_TOKEN" \
    -H "Content-Type: application/json" \
    --data '{"id": "5269debd-22e3-4137-9504-8d039c97eb1a","name": "Block Ads and Malicious HTTP","description": "","precedence": 12000,"enabled": true,"action": "block","filters": ["http"],"created_at": "2022-08-25T09:01:27Z","updated_at": "2022-08-25T09:01:27Z","deleted_at": null,"traffic": "'"$ruleH"'","identity": "","device_posture": "","version": 1,"rule_settings": {"block_page_enabled": false,"block_reason": "Made by Fukuro Aki","override_ips": null,"override_host": "","l4override": null,"biso_admin_controls": {"dp": false,"dcp": false,"dd": false,"du": false,"dk": false},"add_headers": {},"ip_categories": false,"check_session": null,"insecure_disable_dnssec_validation": false}}'
